...
public class Shipping implements Serializable {
    ...
    @Column(name = "shippingid") // Lowercase
    ...
    @NotNull
    @Size(min = 1, max = 255)
    @Column(name = "shippingmethod") // Lowercase
    private String shippingMethod;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 50)
    @Column(name = "shippingstatus") // Lowercase
    private String shippingStatus;
    @Column(name = "estimateddeliverydate") // Lowercase
    @Temporal(TemporalType.DATE)
    private Date estimatedDeliveryDate;
    @Column(name = "actualdeliverydate") // Lowercase
    @Temporal(TemporalType.DATE)
    private Date actualDeliveryDate;
    @Size(max = 255)
    @Column(name = "trackingnumber") // Lowercase
    private String trackingNumber;
    @JoinColumn(name = "orderid", referencedColumnName = "orderid") // Lowercase
    @ManyToOne
    private Orders orderID;
    @JoinColumn(name = "shippingcompanyid", referencedColumnName = "shippingcompanyid") // Lowercase
    @ManyToOne
