                        ...
                        <div class="col l-10 m-12 c-12">
                            <div class="home-filter hide-on-mobile-tablet">
                                ...
                                <!--<div class="select-input">-->
                                    ...
                                    <form class="sort" style="display:flex" action="${pageContext.request.contextPath}/category" method="GET">
                                    ...
                                    <ul class="pagination home-product__pagination">
                                        <li class="pagination-item">
                                            <c:if test="${currentPage > 1}">
                                                <a href="category?page=${currentPage - 1}&cID=${param.cID}&query=${param.query}&weather=${requestScope.weather}&sortOrder=${param.sortOrder}" class="pagination-item__link">
                                        ...
                                        <c:forEach var="i" begin="1" end="${totalPages}">
                                            <li class="pagination-item ${currentPage == i ? 'pagination-item--active' : ''}">
                                                <a href="category?page=${i}&cID=${param.cID != null ? param.cID : 1}&query=${param.query}&weather=${requestScope.weather}&sortOrder=${param.sortOrder}" class="pagination-item__link">${i}</a>
                                            </li>
                                        </c:forEach>
                                        <li class="pagination-item">
                                            <c:if test="${currentPage < totalPages}">
                                                <a href="category?page=${currentPage + 1}&cID=${param.cID != null ? param.cID : 1}&query=${param.query}&weather=${requestScope.weather}&sortOrder=${param.sortOrder}" class="pagination-item__link">
