            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        ...
                        <a href="${pageContext.request.contextPath}/authservlet" class="dropdown-item"><i
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="auth">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link"
                                                    href="${pageContext.request.contextPath}/ligmaShop/admin/managerUser.jsp">Quản
                                lý Người Dùng</a></li>
                            <li class="nav-item"><a class="nav-link"
                                                    href="${pageContext.request.contextPath}/ligmaShop/admin/addUser.jsp">Thêm
                                người dùng mới</a></li>
                        </ul>
                    </div>
                </li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="container-product">
                                    ...
                                    <div style="text-align: center;">
                                        <a href="${pageContext.request.contextPath}/ligmaShop/admin/addNewProduct.jsp"
                                           class="action-btn add-btn">Thêm Sản Phẩm Mới</a>
                                    </div>
                                                ...
                                                <c:forEach var="product" items="${products}" varStatus="status">
                                                    <c:if test="${status.index >= start && status.index < end}">
                                                        ...
                                                        <tr>
                                                                    ...
                                                                    <c:when test="${not empty productImageUrls}">
                                                                        <c:forEach var="imageUrl" items="${productImageUrls}">
                                                                            <img src="${imageUrl}" alt="Product Image" class="product-image"
                                                                                 onerror="this.src='resource/images/default-image.jpg';">
                                                                        </c:forEach>
                                                                    </c:when>
                                                            ...
                                                            <td><fmt:formatNumber value="${avgRatingMap[productId]}"
                                                                                  maxFractionDigits="1"/></td>
                                                            <td>
                                                                <c:choose>
                                                                    <c:when test="${product.status}">
                                                                        <a href="productManager?action=deactivate&id=${product.productID}"
                                                                           class="action-btn delete-btn"
                                                                           onclick="return confirm('Deactivate this product?');">DACT</a>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <a href="productManager?action=activate&id=${product.productID}"
                                                                           class="action-btn activate-btn"
                                                                           onclick="return confirm('Activate this product?');">ACT</a>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                                <a href="productManager?action=edit&id=${product.productID}"
                                                                   class="action-btn update-btn">Edit</a>
                                                            </td>
                                                        </tr>
                                                    </c:if>
                                                </c:forEach>
                                    ...
                                    <div class="pagination">
                                        <c:set var="totalPages"
                                               value="${(products.size() / productsPerPage) + (products.size() % productsPerPage == 0 ? 0 : 1)}"/>
